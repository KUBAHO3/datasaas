...
export const FORMS_TABLE_ID = process.env.NEXT_PUBLIC_FORMS_TABLE_ID!;
export const FORM_SUBMISSIONS_TABLE_ID = process.env.NEXT_PUBLIC_FORM_SUBMISSIONS_TABLE_ID!;
export const SUBMISSION_VALUES_TABLE_ID = process.env.NEXT_PUBLIC_SUBMISSION_VALUES_TABLE_ID!;
export const IMPORT_JOBS_TABLE_ID = process.env.NEXT_PUBLIC_IMPORT_JOBS_TABLE_ID!;
export const IMPORT_TEMP_BUCKET_ID = process.env.NEXT_PUBLIC_IMPORT_TEMP_BUCKET_ID!;
export const INVITATIONS_TABLE_ID = process.env.NEXT_PUBLIC_INVITATIONS_TABLE_ID!;