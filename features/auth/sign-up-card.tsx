...
export function SignUpCard() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-4">
            <Card className="w-full sm:max-w-2xl shadow-lg">
                ...
                <CardFooter className="flex flex-col gap-4">
                    ...
                    <div className=" hidden items-center gap-3 before:h-px w-full before:flex-1 before:bg-border after:h-px after:flex-1 after:bg-border">
                        <span className="text-xs text-muted-foreground">Or</span>
                    </div>

                    <Button variant="outline" type="button" className="w-full hidden" disabled={isSigningUp}>
